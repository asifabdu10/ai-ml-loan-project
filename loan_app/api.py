...
def predict_with_model(ap: dict):
    ...
    # Transform categorical variables using loaded encoders
    ...
    # Ensure feature array order matches what model was trained on
...
def get_info():
    if bundle is None:
        return {"loaded": False, "error": "loan_model.pkl not found"}
    return {
        "loaded": True,
